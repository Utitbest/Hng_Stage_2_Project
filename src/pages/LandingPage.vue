<template>
  <div>
    ...
    <main class="landing-page container" data-testid="test-landing-page">
      <section class="hero">
        <div class="hero-content">
          ...
          <div class="cta-buttons">
            <router-link to="/auth/login" class="btn btn-primary1">
              Login
            </router-link>
            <router-link to="/auth/signup" class="btn btn-outline">
              Get Started
            </router-link>
          </div>
        </div>
